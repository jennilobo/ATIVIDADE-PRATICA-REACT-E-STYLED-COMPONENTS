...
import { Footer, FooterText, Link, LinkGroup, SocialIcons } from "./Footer/styled";
...
function App() {
  ...
  return (<>
    ...
    <DivPrincipal>
      ...
      <IconMain icon={<AiOutlineCheckCircle />} title="Fácil aproveitamento" description="Estamos no caminho." />
    </DivPrincipal>
    ...
    <Footer>
      <div>
        ...
        <div>
          <FooterText>©Your Website 2023. All Rights Reserved.</FooterText>
        </div>
      </div >
      <SocialIcons>
        <a href="https://github.com/jennilobo" target="_blank">
          <FontAwesomeIcon icon={faGithub} style={{ color: "#007afc", marginRight: "30px" }} />
        </a>
        <a href="https://www.linkedin.com/in/jennifer-lobo-983bb91b2/" target="_blank">
          <FontAwesomeIcon icon={faLinkedin} style={{ color: "#007afc", marginRight: "10px" }} />
        </a>
      </SocialIcons>
    </Footer >
  </>
